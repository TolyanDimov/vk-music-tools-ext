...
- **VK Музыка:** массовое добавление/снятие треков в режиме редактирования плейлиста, удаление загруженных треков из музыки.
...
4. Прогресс удаления отображается в консоли страницы.
